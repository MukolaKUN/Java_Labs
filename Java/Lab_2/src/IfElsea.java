public class IfElsea {
    ...
    static void c()
    {
        ...
        String argument2 = "і через 20 хв до мене дойшло";
        int arg1 = argument1.length();
        int arg2 = argument2.length();
        String ar1 = "Аргумент 1";
        String ar2 = "Аргумент 2";

        //System.out.println("аргумент з більшою довжиною - " + ((arg1 > arg2) ? arg1 : arg2));
        System.out.println("аргумент з більшою довжиною - " + ((arg1 > arg2) ?  ar1 : ar2));
